...
impl NodeIndex {
    ...
    #[inline]
    pub(crate) fn as_leaf(&self) -> LeafIndex {
        (*self).into()
    }
    #[inline]
    pub(crate) fn as_branching(&self) -> BranchingIndex {
        (*self).into()
    }
}
...
impl LeafIndex {
    ...
    #[inline]
    pub(crate) fn is_root_leaf(&self) -> bool {
        self.0 == 0
    }
    #[inline]
...
impl PartialEq<LeafIndex> for NodeIndex {
    #[inline]
    fn eq(&self, other: &LeafIndex) -> bool {
        self.0 == !other.0
    }
}
...
impl PartialEq<BranchingIndex> for NodeIndex {
    #[inline]
    fn eq(&self, other: &BranchingIndex) -> bool {
        self.0 == other.0
    }
}
